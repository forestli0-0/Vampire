...
**Vampire** 是一款使用 LÖVE 2D 引擎（Lua）开发的 2D 俯视角 Roguelite 射击游戏。游戏灵感来源于：
...
### 🔫 战斗系统
- **15+ 种武器**：步枪、霰弹枪、狙击枪、弓箭、手枪、能量武器、近战武器
...
- **70+ 种 MOD 卡**：伤害、暴击、元素、生存等多种增益

### 👾 敌人与战斗
- **12+ 种敌人类型**：近战冲锋、远程射击、自爆、勾索、护盾等
- **Warframe 伤害类型**：切割、穿刺、冲击 + 元素组合
- **攻击预警系统**：敌人攻击前有明确的视觉提示

### 🗺️ 房间进度系统
- **Hades 风格关卡流**：清理房间 → 选择奖励 → 进入下一房间
- **任务类型**：歼灭、防御、生存三种玩法
- **Boss 战**：阶段性大型 Boss 挑战
...
<p align="center">
  <strong>⭐ 如果觉得项目有帮助，欢迎 Star！</strong>
</p>
