...
function draw.renderUI(state)
    ...
    --     -- Legacy Game Clear drawing removed. Handled by ui.screens.gameover
    -- end

    -- if state.gameState == 'GAME_OVER' then
    --     -- Legacy Game Over drawing removed. Handled by ui.screens.gameover
    -- end

    -- if state.gameState == 'SHOP' then
    --     -- Legacy Shop drawing removed. Handled by ui.screens.shop
    -- end

    -- if state.gameState == 'LEVEL_UP' then
    --     -- Legacy drawing removed. Handled by ui.screens.levelup
    -- end
end
