...
local enemyDefs = {
    skeleton = {
        ...
        attacks = {
            ...
            throw = {range = 200, rangeMin = 60, windup = 0.5, cooldown = 3.0, damage = 6, bulletSpeed = 365, bulletLife = 2, bulletSize = 8, w = 3}
        }
    },
    bat = {
        hp = 8,
    ...
    plant = {
        ...
        healthType = 'INFESTED',
        attacks = {
            burst = {range = 400, rangeMin = 80, windup = 0.6, count = 3, spread = 0.4, bulletSpeed = 340, bulletDamage = 8, bulletLife = 4, bulletSize = 10, cooldown = 3.5, w = 10}
        }
    },
    charger = {
        hp = 27,
    ...
    spore_mortar = {
        ...
        attacks = {
            ...
            burst = {range = 500, rangeMin = 150, windup = 0.7, count = 5, spread = 0.6, bulletSpeed = 310, bulletDamage = 6, bulletLife = 3, bulletSize = 8, cooldown = 4.0, w = 5}
        }
    },
    dummy_pole = {
        hp = 800,
    ...
    lancer = {
        ...
        attacks = {
            shoot = {range = 350, rangeMin = 100, windup = 0.6, cooldown = 1.8, 
                     count = 1, spread = 0.05, bulletSpeed = 585, bulletDamage = 10, 
    ...
    heavy_gunner = {
        ...
        attacks = {
            burst = {range = 320, rangeMin = 80, windup = 0.4, cooldown = 2.0,
                     count = 6, spread = 0.35, bulletSpeed = 495, bulletDamage = 6, 
    ...
    ballista = {
        ...
        attacks = {
            snipe = {range = 600, rangeMin = 200, windup = 1.2, cooldown = 4.0,
                     count = 1, spread = 0, bulletSpeed = 845, bulletDamage = 35, 
    ...
    bombard = {
        ...
        attacks = {
            rocket = {range = 400, rangeMin = 120, windup = 0.9, cooldown = 3.5,
                      count = 1, spread = 0, bulletSpeed = 390, bulletDamage = 28, 
    ...
    nullifier = {
        ...
        attacks = {
            shoot = {range = 280, rangeMin = 60, windup = 0.5, cooldown = 2.0,
                     count = 1, spread = 0.1, bulletSpeed = 415, bulletDamage = 8, 
