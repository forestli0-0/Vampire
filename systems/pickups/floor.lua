...
merge(require('systems.pickups.floor_handlers.combat'))
merge(require('systems.pickups.floor_handlers.mission'))
merge(require('systems.pickups.floor_handlers.pets'))
merge(require('systems.pickups.floor_handlers.shop'))
